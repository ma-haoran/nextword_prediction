...
* The Shiny application can be visualized at the link: [data science application](https://ma-haoran.shinyapps.io/nextwordApp/)
...
## link
[App](https://ma-haoran.shinyapps.io/nextwordApp/)

[Code](https://github.com/ma-haoran/nextword_prediction)
