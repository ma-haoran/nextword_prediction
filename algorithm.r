...
twitter <- slice_sample(twitter, prop = 0.01)
blog <- slice_sample(blog, prop = 0.01)
news <- slice_sample(news, prop = 0.01)
...
# output train data
write_csv(all,"C:/Users/Apple/Desktop/RStudio Tour/assignment/assignment10/nextword_prediction/train_data.csv",col_names = FALSE)
...
# output train data
write.table(all,
          file = "C:/Users/Apple/Desktop/RStudio Tour/assignment/assignment10/nextword_prediction/train_data.csv")
